...
namespace BattleOfTheShip1.GameObject
{
    public class HealthPackGreen
    {
        ...
        static HealthPackGreen()
        {
            _spawnTimer.Start();
        }


        public HealthPackGreen()
        {
        ...
        {
            _bitmap = SplashKit.LoadBitmap("HealthPackGreen", "C:\\Users\\Admin\\Desktop\\Swinburne\\BattleOfTheShip\\media\\images\\health_green_resized.png");  // Load the ammo reload image
        }
